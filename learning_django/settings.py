...
class Base(Configuration):
    ...
    SECRET_KEY = values.Value('jdOGDJYntLmfVSlRBawPtjEnIaftEZjuqzyYltKfQAGsaMqCma')
    ...
    LEARNING_DJANGO_APPS = ["japan_foods"]
    ...
    MIDDLEWARE = [
        ...
        "learning_django.middleware.TimezoneMiddleware",
...
class Testing(Development):
    ...
    DATABASES = values.DatabaseURLValue( # This is about defaulting to running vs docker db if you don't specify something else
        "postgresql://learning_django_user:learning_django_pass@127.0.0.1:5433/learning_django_db")
